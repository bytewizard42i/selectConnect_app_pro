...
|------|-----|--------------|
| `SelectConnect.compact` | 2025 MVP | Pre-engine, monolithic design |
| `SelectConnectMVP.compact` | 2025 MVP | Pre-engine, monolithic design |
| `SelectConnectProtocol.compact` | 2025 | Pre-engine, monolithic design |
| `AbuseEscrow.compact` | 2025 | Pre-engine, replaced by v2 with 3 security fixes |
